...
public class ActivityProsesFrom4To7 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bTerima.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(ActivityProsesFrom4To7.this)
                        .setTitle("Terima Job")
        ...
        new Netter(this).webService(Request.Method.POST, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(ActivityProsesFrom4To7.this, "Gagal memuat data", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
