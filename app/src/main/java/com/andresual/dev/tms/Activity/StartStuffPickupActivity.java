...
public class StartStuffPickupActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_stuff_pickup);
        modelData = getIntent().getParcelableExtra(SebelumnyaListAdapter.INTENT_DATA);
        Button btnStartStuff = findViewById(R.id.btn_start_to_stuff_pickup);
...
//        delivLng = this.getIntent().getStringExtra("delivLng");
        ...
        btnStartStuff.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void startLoading() {
        ...
        params.put("f", "finishjobdeparture");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(StartStuffPickupActivity.this, FinishStuffPickupActivity.class);
