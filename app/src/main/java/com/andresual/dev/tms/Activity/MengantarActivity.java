...
//                OperationalController.getmInstance().mengantarJob(MengantarActivity.this);
        ...
        btnTolak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MengantarActivity.this, TolakOrderActivity.class);
...
//        }
    ...
    public void mengantarJob() {
        ...
        params.put("f", "arrivedestination");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(MengantarActivity.this, ArriveDestinationActivity.class);
                            intent.putExtra("jobId", jobId);
