...
public class OrderBaruDCPActivity extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTolak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrderBaruDCPActivity.this, TolakOrderActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(OrderBaruDCPActivity.this, MapsOrderDCPActivity.class);
                            intent.putExtra("jobId", jobId);
