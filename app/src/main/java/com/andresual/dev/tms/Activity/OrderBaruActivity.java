...
public class OrderBaruActivity extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (jobType == 1) {
            ...
            tvContType.setVisibility(View.INVISIBLE);
            tvComodity.setVisibility(View.INVISIBLE);
        }
        ...
        btnTolak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrderBaruActivity.this, TolakOrderActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(OrderBaruActivity.this, MapsOrderActivity.class);
                            intent.putExtra("jobId", jobId);
