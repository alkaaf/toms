...
public class MapsOrderActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
...
//        jobType = this.getIntent().getIntExtra("jobType", 0);
        ...
        Dialog dialog = new AlertDialog.Builder(this)
                ...
                .setNegativeButton("Tidak", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(MapsOrderActivity.this, DashboardActivity.class);
...
//                OperationalController.getmInstance().jemputJob(MapsOrderActivity.this);
        ...
        btnBatal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MapsOrderActivity.this, TolakOrderActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(MapsOrderActivity.this, SiapAntarActivity.class);
                            intent.putExtra("jobId", jobId);
