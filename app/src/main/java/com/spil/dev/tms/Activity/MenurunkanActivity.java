...
public class MenurunkanActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, DirectionFinderListener {
...
//                OperationalController.getmInstance().menurunkanJob(MenurunkanActivity.this);
                menurunkanJob();
                Intent intent = new Intent(MenurunkanActivity.this, UploadFotoActivity.class);
