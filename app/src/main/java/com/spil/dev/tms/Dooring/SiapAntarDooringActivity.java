...
//        delivLng = this.getIntent().getStringExtra("delivLng");
        ...
        btnSiapAntar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (delivLat == null) {
                    Intent intent = new Intent(SiapAntarDooringActivity.this, DashboardActivity.class);
        ...
        btnTolak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SiapAntarDooringActivity.this, TolakOrderActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(SiapAntarDooringActivity.this, MengantarDooringActivity.class);
                            intent.putExtra("jobId", jobId);
