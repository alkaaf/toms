package com.spil.dev.tms.Dooring;
...
public class MapsOrderDooringActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
...
//        delivLng = this.getIntent().getStringExtra("delivLng");
        ...
        Dialog dialog = new AlertDialog.Builder(this)
                ...
                .setNegativeButton("Tidak", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(MapsOrderDooringActivity.this, DashboardActivity.class);
...
//                OperationalController.getmInstance().jemputJob(MapsOrderActivity.this);
        ...
        btnBatal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MapsOrderDooringActivity.this, TolakOrderActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(MapsOrderDooringActivity.this, SiapAntarDooringActivity.class);
                            intent.putExtra("jobId", jobId);
