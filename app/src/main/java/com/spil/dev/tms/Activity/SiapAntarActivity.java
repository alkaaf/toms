...
//        jobType = this.getIntent().getIntExtra("jobType", 0);
        ...
        btnSiapAntar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (delivLat == null) {
                    Intent intent = new Intent(SiapAntarActivity.this, DashboardActivity.class);
        ...
        btnTolak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SiapAntarActivity.this, TolakOrderActivity.class);
...
//        getGeofence();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Intent intent = new Intent(SiapAntarActivity.this, ReadyToStuffPickupActivity.class);
                            intent.putExtra("jobId", jobId);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String tujuan = obj.getJSONObject("depo").getString("tujuan");
                            Log.i("onResponse: ", tujuan);
    ...
    public void fetchGeofence() {
        ...
        {
            btnSiapAntar.setVisibility(View.INVISIBLE);
        }
        else
        {
            btnSiapAntar.setVisibility(View.VISIBLE);
