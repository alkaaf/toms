...
public class ActivityProses3 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bTerima.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(ActivityProses3.this)
                        .setTitle("Terima Job")
        ...
        bTolak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityReject.start(ActivityProses3.this, job);
            }
        });
    }
    ...
    public static void startProses(Context context, SimpleJob simpleJob) {
        Intent intent = new Intent(context, ActivityProses3.class);
