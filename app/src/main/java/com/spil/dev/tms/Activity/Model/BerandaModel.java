...
/**
 * Created by andresual on 2/14/2018.
 */

public class BerandaModel {

    private int portorderid;
    private String consignee_id;
    private int container_cargo_id;
    ...
    private int fleet_driver_id;
    private String fleet_driver_name;
    private int fleet_driver_score;
    ...
    private String job_deliver_latitude;
    private String job_deliver_longitude;
    ...
    public int getPortorderid() {
        return portorderid;
    }

    public void setPortorderid(int portorderid) {
    ...
    public int getContainer_cargo_id() {
        return container_cargo_id;
    }

    public void setContainer_cargo_id(int container_cargo_id) {
    ...
    public int getFleet_driver_id() {
        return fleet_driver_id;
    }

    public void setFleet_driver_id(int fleet_driver_id) {
    ...
    public int getFleet_driver_score() {
        return fleet_driver_score;
    }

    public void setFleet_driver_score(int fleet_driver_score) {
    ...
    public String getJob_deliver_latitude() {
        return job_deliver_latitude;
    }

    public void setJob_deliver_latitude(String job_deliver_latitude) {
        this.job_deliver_latitude = job_deliver_latitude;
    }

    public String getJob_deliver_longitude() {
        return job_deliver_longitude;
    }

    public void setJob_deliver_longitude(String job_deliver_longitude) {
